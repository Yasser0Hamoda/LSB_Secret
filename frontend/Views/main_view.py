...
"")
        ...
        spacerItem1 = QtWidgets.QSpacerItem(20, 151, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Maximum)
...
"}")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/img/download.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.selectImageButton.setIcon(icon5)
...
"}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/img/output-onlinepngtools.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 676, 573))
